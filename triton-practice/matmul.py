...
@triton.autotune(
    configs=get_group_autotune_config(),
    key=["M", "N", "K"]
)
@triton.jit
...
@triton.testing.perf_report(
    triton.testing.Benchmark(
        ...
        line_arg="provider",
        line_vals=["torch", "triton", "triton-group"],
        line_names=["Torch", "Triton", "Triton-Group"],
...
def benchmark(M, N, K, provider):
    ...
    if provider == "triton-group":
        ms, min_ms, max_ms = triton.testing.do_bench(lambda: group_matmul(a, b), quantiles=quantiles)
...
if __name__ == "__main__":
    ...
    # triton_output = group_matmul(a, b)
    # torch_output = torch.matmul(a, b)
    # if torch.allclose(triton_output, torch_output):
    #     print("Triton and Torch Match.")
    # else:
    #     print("Triton and Torch Mismatch.")
